...
Supersedes the rejected scalar-MSE-retention branches (calib010 / v2 / v2b / v3 / v3b). Read the experiment ledger first: `docs/2026-06-26-targeted-value-calibration-experiment-ledger-v3f-v4-overlap-updated-v6-prep.md`. This design implements the ledger's "Next planned hypothesis — v4: Teacher-Retention Anchors."
...
| `docs/2026-06-26-targeted-value-calibration-experiment-ledger-v3f-v4-overlap-updated-v6-prep.md` | Append the v4 result row (template in §11) after the run; update do-not-repeat / severe-overlap. |
