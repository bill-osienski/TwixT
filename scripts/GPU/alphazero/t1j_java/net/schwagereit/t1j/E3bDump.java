...
/*
 * PROVENANCE. This file is original code written for E3b. It contains no T1j
 * source. It declares T1j's own package deliberately, because the members it
 * needs -- the Match constructor, setlastMove, getBoardY/getBoardX -- are
 * package-visible. It is compiled against, and links with, T1j (GPL-3.0), which
 * is neither modified nor redistributed here; only this helper is committed.
 */
